...
// For self-signed certificates, set NODE_TLS_REJECT_UNAUTHORIZED=0 in production environment
// Default is to verify certificates (NODE_TLS_REJECT_UNAUTHORIZED is not set or != '0')
